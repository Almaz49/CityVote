# FINAL MERGED LEXICON — manual + auto
# Generated by merge_handlers_lexicons.py
...
LEXICON_HANDLERS_RU = {
    "admin": {
        ...
        "ban_cancelled": 'Спасибо! Новый бан не добавлен!\nПопробуйте еще раз.\nВы вышли из машины состояний',
        "ban_confirm_user_data": 'Данные участника которому вы хотите забанить:\nИмя: {first_name},\n    Фамилия: {last_name}, \n Телефон: {tg_phone_number}\n    Псевдоним: {username} Всё верно?',
        "ban_enter_user_id_or_contact": 'Пожалуйста, введите телеграм-ID участника,\nкоторого вы хотите забанить или отправьте контакт с ID',
        "choose_action": 'Выберите действие',
        "choose_ban_period_or_cancel": 'Выберите, какой срок бана вы хотите назначить. \nЕсли хотите прервать процедуру - наберите /cancel',
        ...
        "confirm_new_registrator": 'Данные участника, которого вы назначаете регистратором:\n{user_info}\nВсё верно?',
        ...
        "registrator_added_success": 'Спасибо! Кандидат в Регистраторы добавлен!\nРезультат отправки сообщения кандидату:\n{response}\nВы вышли из машины состояний',
        "registrator_card": 'Регистратор: {username} {first_name} {last_name}',
        "registrator_invitation_message": 'Здравствуйте! Администрация группы назначила вас регистратором.\nЭто означает, что вам будут приходить заявки на вступления в группу, которые вы можете подтверждать или игнорировать.\nЕсли вы согласны на роль Регистратора, нажмите кнопку "Согласен".\nЕсли не согласны - кнопку "Не согласен"',
        "registrator_not_added": 'Спасибо! Регистратор не добавлен!\nПопробуйте еще раз.\nВы вышли из машины состояний',
