...
- voting_status - статус голосования (завершилось, идет сбор вариантов, идет голосование) ('add_variants','ongoing','finished')
...
2. Вместо кнопки "главное меню" сразу присылать главное меню, если кнопка одна.
3. Доработать обработку нажатия кнопки "Стать представителем". После нее присылается
неадекватное меню.
